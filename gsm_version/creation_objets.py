from gsm_version.getter_setter_maker import create_object
...
def creer_joueurs(nbr_joueurs=2):  # Mettre input() à la place de 1 à la mise en production

    def demander_nom_joueurs(nbr):
        rep = []
        for i in range(nbr):
    ...
    joueurs = {
        "nom": demander_nom_joueurs(nbr_joueurs),
