from gsm_version.write_in_file import insert_line_into_file, iter_file


def create_class(verbose=False, nom_classe=None, input_attributs=None, tab='    '):
    # Cette version de la fonction est obsolète par rapport à class_creator est doit être mise à jour
    if verbose:
